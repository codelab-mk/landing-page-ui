...
export const About1 = () => {
  const features: string[] = ["Our Expert Trainers", "Online Remote Learning", "Easy to follow curriculum", "Lifetime Access"];
  return (
          ...
          <div className="col-lg-6 col-12 order-class">
            ...
            <div className="ed-about__content">
              <div className="ed-section-head">
                <span className="ed-section-head__sm-title">WELCOME TO CodeLab</span>
                <h3 className="ed-section-head__title ed-split-text left">
                  Digital Online Academy: Your <br />
                  Path to Creative Excellence
                </h3>
                <p className="ed-section-head__text">Excedteur sint occaecat cupidatat non proident sunt in culpa qui officia deserunt mollit.</p>
              </div>
...
export const About2 = () => {
  const features = ["Our Expert Trainers", "Online Remote Learning", "Easy to follow curriculum", "Lifetime Access"];
  return (
      ...
      <div className="container ed-container">
        <div className="row align-items-center">
          <div className="col-lg-6 col-12">
            ...
            <div className="ed-about__content">
              <div className="ed-section-head">
                <span className="ed-section-head__sm-title">ABOUT OUR COURSES</span>
                <h3 className="ed-section-head__title ed-split-text right">
                  Digital Online Academy: Your <br />
                  Path to Creative Excellence
                </h3>
                <p className="ed-section-head__text">Excepteur sint occaecat cupidatat non proident sunt in culpa qui officia deserunt mollit.</p>
              </div>
              <div className="ed-about__feature">
                <ul className="ed-about__features-list">
                  {features.map((feature, index) => (
          ...
          <div className="col-lg-6 col-12">
            ...
            <div className="ed-about__images ed-about__images--style2">
              <div className="ed-about__main-img-style2">
                <Image width={0} height={0} sizes="100vw" style={{ width: "100%", height: "auto" }} className="ed-about__main-img-1" src="/assets/images/about/about-2/about-img-1.png" alt="about-img-1" />
                <Image width={0} height={0} sizes="100vw" style={{ width: "100%", height: "auto" }} className="ed-about__main-img-2" src="/assets/images/about/about-2/about-img-2.png" alt="about-img-1" />
              </div>
              <div className="counter-card updown-ani">
                <div className="counter-card__icon">
                  <i className="fi fi-rr-graduation-cap" />
              ...
              <div className="ed-about__shapes">
                <Image width={79} height={49} sizes="100vw" style={{ width: "79px", height: "49px" }} className="ed-about__shape-1" src="/assets/images/about/about-2/shape-1.svg" alt="shape-1" />
                <Image width={135} height={134} sizes="100vw" style={{ width: "135px", height: "134px" }} className="ed-about__shape-2" src="/assets/images/about/about-2/shape-2.svg" alt="shape-2" />
                <Image width={83} height={74} sizes="100vw" style={{ width: "83px", height: "74px" }} className="ed-about__shape-3 rotate-ani" src="/assets/images/about/about-2/shape-3.svg" alt="shape-3" />
              </div>
            </div>
          </div>
        </div>
